...
def welcome_greeting():
    ...
    if current_user and current_user.is_authenticated:
        ...
        if current_user.is_admin():
            text = f"أهلاً بك يا مدير {display_name} في لوحة دريم إس إم إس."
            lang = 'ar'
        elif current_user.is_agent():
            if name_lang == 'ar':
                text = f"أهلاً بك يا وكيل {display_name} في لوحة دريم إس إم إس."
                lang = 'ar'
            else:
            ...
            if name_lang == 'ar':
                text = f"أهلاً بك يا {display_name} في لوحة دريم إس إم إس."
                lang = 'ar'
            else:
